...
describe('favorite blog', () => {
  ...
  test('when run, return blog with highest likes', () => {
...
describe('most blog', () => {
  ...
  test('when run, return first author with highest number of blog', () => {
...
describe('most blog', () => {
  ...
  test('when run, return first author with highest number of likes', () => {
